#  D1 Mini ESP8266
      ...
      GPIO12/D6 ← │~□ D6/MISO      #!1 FLASH/D3 ▲~│ → D3/GPIO0
      GPIO13/D7 ← │~□ D7/MOSI            LED/D4 □~│ → D4/GPIO2
      GPIO15/D8 ← │~▲ D8/CS #!2             GND □ │ → GND
           3.3V ← │ □ 3.3V                   5V □ │ → 5V
                  ╰─╮                             │
                   ●│(RST BTN) ┌─────┐  D1 MINI   │
                    └──────────┤USB-C├────────────┘
...
- `#!1` Pin D3 (GPIO0) requires a 10 kΩ pull-up resistor to ensure proper boot.
- `#!2` Pin D8 (GPIO15) may require a 10 kΩ pull-down resistor to prevent boot failure.
