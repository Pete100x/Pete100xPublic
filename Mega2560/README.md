# Arduino Mega ATmega2560
                   ...
                   ┌────┤ PWR ├─────────────────┤ USB ├──┐
                   │    │6–20V│                 │  B  │  │
                   │    └─────┘   GND □ RST2 □  └─────┘  │              ← □ GND = GND      ← □ RST2 = RST2       
                   │            MOSI2 □ SCK2 □  SCL/D0 □ │  →   D0      ← □ MOSI2 = MOSI2  ← □ SCK2 = SCK2     
                   │               5V □ MISO2□  SDA/D1 □ │  →   D1      ← □ 5V = 5V        ← □ MISO2 = MISO2          
                   │                              AREF □ │  →   AREF                                     
                   │                               GND □ │  →   GND                                     
       N/C      ←  │ □ N/C                     LED/D13 □~│  →   D13                                   
       IOREF    ←  │ □ IOREF                       D12 □~│  →   D12                                     
       ...
       A15/D69  ←  │ □ A15/D69     RST SCK MISO          │    ← □ MISO = MISO    ← □ 5V = 5V     
                   ...
                   │                □   □   □            │    ← □ RST = RST      ← □ GND = GND     
                   │               GND MOSI 5V           │             
                   │                  ● (RST BTN)        │    ← □ 22 = D22/A0    ← □ 23 = D23/A1                                       
                   │ G                                   │    ← □ 24 = D24/A2    ← □ 25 = D25/A3        
                   │ N 5 5 4 4 4 4 4 3 3 3 3 3 2 2 2 2 5 │    ← □ 26 = D26/A4    ← □ 27 = D27/A5        
                   │ D 2 0 8 6 4 2 0 8 6 4 2 0 8 6 4 2 V │    ← □ 28 = D28/A6    ← □ 29 = D29/A7        
                   │         ~ ~                         │    ← □ 30 = D30       ← □ 31 = D31           
                   │ ↑ ↑ ↑ ↑ ↑ ↑ ↑ ↑ ↑ ↑ ↑ ↑ ↑ ↑ ↑ ↑ ↑ ↑ │    ← □ 32 = D32       ← □ 33 = D33           
                   │ □ □ □ □ □ □ □ □ □ □ □ □ □ □ □ □ □ □ │    ← □ 34 = D34       ← □ 35 = D35           
                   │ □ □ □ □ □ □ □ □ □ □ □ □ □ □ □ □ □ □ │    ← □ 36 = D36       ← □ 37 = D37           
                   │ ↓ ↓ ↓ ↓ ↓ ↓ ↓ ↓ ↓ ↓ ↓ ↓ ↓ ↓ ↓ ↓ ↓ ↓ │    ← □ 38 = D38       ← □ 39 = D39           
                   │           ~                         │    ← □ 40 = D40       ← □ 41 = D41           
                   │ G 5 5 4 4 4 4 4 3 3 3 3 3 2 2 2 2 5 │    ← □ 42 = D42       ← □ 43 = D43                
                   │ N 3 1 9 7 5 3 1 9 7 5 3 1 9 7 5 3 V │    ← □~44 = D44       ← □~45 = D45              
                   │ D                                   │    ← □~46 = D46       ← □ 47 = D47              
                   │                                     │    ← □ 48 = D48       ← □ 49 = D49                                                
                   │ ATMEGA2560              ╭───────────╯    ← □ 50 = D50/MISO  ← □ 51 = D51/MOSI                                             
                   ╰─────────────────────────╯                ← □ 52 = D52/SCK   ← □ 53 = D53/SS                                                                             
