...
## ESP8266 D1 Mini
        ...
        RST       ←   │ □ RST      │  2  │       TX □~│  →   GPIO01
        A0        ←   │ □ A0       │  6  │       RX □~│  →   GPIO03
        GPIO16    ←   │~□ D0/WAKE  │  6  │   SCL/D1 □~│  →   GPIO05
        GPIO14    ←   │~□ D5/SCLK  └─────┘   SDA/D2 □~│  →   GPIO04
        GPIO12    ←   │~□ D6/MISO          FLASH/D3 □~│  →   GPIO00
        GPIO13    ←   │~□ D7/MOSI            LED/D4 X~│  →   GPIO02
        GPIO15    ←   │~□ D8/CS                 GND □ │  →   GND
        3.3V      ←   │ □ 3.3V                   5V □ │  →   5V
                      ╰─╮                             │
                       ●│RST BTN   ┌─────┐  D1 MINI   │
                        └──────────┤USB-C├────────────┘
             ...
             ADC0    | [ ]A0      |  6  |      RX[ ]~|    GPIO03
           GPIO16    |~[ ]D0/WAKE |  6  |  SCL/D1[ ]~|    GPIO05
           GPIO14    |~[ ]D5/SCLK |_____|  SDA/D2[ ]~|    GPIO04
           GPIO12    |~[ ]D6/MISO        FLASH/D3[ ]~|    GPIO00
           GPIO13    |~[ ]D7/MOSI              D4[ ]~|    GPIO02
           GPIO15    |~[ ]D8/CS               GND[ ] |
                     | [ ]3.3V                 5V[ ] |
                      \                              |
                       O RST BTN  +-----+  D1 MINI   |
